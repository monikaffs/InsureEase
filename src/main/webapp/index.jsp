...
<div class="navbar">Welcome to InsureEase</div>
...
Provides real-time status tracking for better transparency.
      </p>
    </div>
...
Improves productivity with an intuitive, user-friendly interface.
      </p>
    </div>
...
Reduces the risk of fraud through automated checks.
      </p>
    </div>
...
<section class="why-choose-section">
  ...
  <div class="why-grid">
    ...
    <div class="why-card">
      ...
      <p>
         Your claim data is handled through validated workflows designed to
  maintain accuracy and confidentiality. Built-in safeguards ensure
  every submission remains secure and consistent.
      </p>
    </div>
